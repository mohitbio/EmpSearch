...
function InstantSearchController($scope,$http){
	...
	// but are hardcoded here for simplicity. See the below 
	// tips on using AJAX.
     /*
     var url = "data/mock-data.json";
	 $http.get(url).success( function(response) {
	  $scope.items = response; 
	}); 
    */
	$scope.items = [{"id":1,"gender":"M","name":"Phillip Reyes","email":"preyes0@imdb.com","city":"Austin"},
